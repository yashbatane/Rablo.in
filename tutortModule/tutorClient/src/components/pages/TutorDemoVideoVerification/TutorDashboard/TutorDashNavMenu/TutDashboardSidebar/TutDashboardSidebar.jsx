...
const MenuItem = ({ icon, text, selectedTab, id, handleClick, path, profileTab }) => {
  return (
    <span
      className={`menuItem ${selectedTab === id ? "selected" : ""} ${profileTab === "profileSubelements" ? "profileSubelements" : ""}`}
...
const selectedTab=useSelector(state=>state.sidebar.selectedTab);
...
const dispatch=useDispatch();
  ...
  return (
    <div className="SidebarContainer">
      ...
      <div className="menu">
        <p className="sectionHeading">Menu</p>
        <MenuItem
          text="Home"
          id="1"
      ...
      <div className="social">
        <p className="sectionHeading">Social</p>
