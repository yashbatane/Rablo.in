...
import CInput from "../../../../GlobalComponents/Inputs/CInput/CInput";
import BackButton from "../../../../GlobalComponents/Buttons/BackButton/BackButton";
import StepOTPButton from "../../../../GlobalComponents/Buttons/StepOTPButton/StepOTPButton";
import { useNavigate } from "react-router";
import OTPInput from "../../../../GlobalComponents/Inputs/OTPInput/OTPInput";
...
const OTPverification = () => {
    ...
    return (
        <div className="verifypage">
            ...
            <div>
                Verifying your number will give  access to more features on Rablo. Click the button to send a verification email
            </div>
            <div>
                {
                    (!send)?<CInput/>:<OTPInput/>
                }
            </div>

            <div>
                <div>
                    <BackButton onClick={() => (send)?setSend(false):navigate("/register")} />
                </div>
                <div>
                    <StepOTPButton text={(!send) ? "Step OTP >" : "Verify >"} onClick={()=>send?null:setSend}/>
                </div>
            </div>
        </div>
    );
