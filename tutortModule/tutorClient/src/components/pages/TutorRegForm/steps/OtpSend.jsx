...
export default function OtpSend({ setStep }) {
  ...
  const handleSubmitClick = () => {
    if (otp.length !== 10) {
      // Display an error message or handle the case when the entered OTP is not 10 digits
      return;
    }
  ...
  return (
    ...
    <div className="logootpsend">
      ...
      <div className="OtpInputSend">
        <input
          type="text"
          className="startingphno"
          value="+91"
          readOnly
        />
        <input
          name="OtpInput"
          className="OtpModalSend"
          style={{ paddingLeft: "5%" }}
          maxLength={10}
          pattern="[0-9]*"
          value={otp}
      ...
      <div className="Buttons">
        ...
        <button
          ...
          style = { {alignItems:"ce" }}
        >Send OTP<IoIosArrowForward style = { {color: "white" ,paddingLeft:"2%" }}/>
        </button>
      </div>
    </div>
  );
