...
import YourTutorTable from './RequestTabsTable.jsx';
// import profilePic from "./Images/profilePic.png";
...
const RequestTabs = () => {
  ...
  useEffect(()=>{
    axios.get(`http://localhost:5003/api/requests/accepted/${tutorId}`)
    ...
    axios.get(`http://localhost:5003/api/requests/received/${tutorId}`)
    .then(function(response){
      setPending(res.data)
    })
    .catch(function(error){
    ...
    axios.get(`http://localhost:5003/api/requests/declined/${tutorId}`)
    .then(function(response){
      setRethink(res.data)
    })
    .catch(function(error){
