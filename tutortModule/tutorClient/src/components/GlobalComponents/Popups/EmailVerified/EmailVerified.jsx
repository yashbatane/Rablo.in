...
function MobileNumberVerified() {
    return (
        <div className="emailVerifiedParent" style={{ position: "absolute", height: "100vh", width: "100%", backgroundColor: "rgba(0, 0, 0, 0.30)", zIndex: 1, justifyContent: "center", alignItems: "center", display: "flex" }}>
            <div className="emailVerifiedBackground">
                <div className="emailVerifiedContainer">

                    <div className="emailVerifiedtitle">
                        ...
                        <h1 style={{ color: "rgba(101, 6, 6, 0.80)", textAlign: "center", fontSize: "23px", fontStyle: "normal", fontWeight: "600", lineHeight: "normal", marginTop: "-35px" }}>Email Verified!</h1>
                    </div>
                    <div className="emailVerifiedbody">
                        Your Email has been successfully Verified
                    </div>
                    <div className="emailVerifiedfooter">
