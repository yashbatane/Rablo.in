...
function Updated() {
    return (
        <div className="updatedParent" style={{ position: "absolute", height: "100vh", width: "100%", backgroundColor: "rgba(0, 0, 0, 0.30)", zIndex: 1, justifyContent: "center", alignItems: "center", display: "flex" }}>
            <div className="updatedBackground">
                <div className="updatedContainer">
                    <div className="updatedtitleCloseBtn">
                        <button>
                    ...
                    <div className="updatedtitle">
                        ...
                        <h1 style={{ color: "rgba(101, 6, 6, 0.80)", textAlign: "center", fontSize: "23px", fontStyle: "normal", fontWeight: "600", lineHeight: "normal", marginTop: "-35px" }}>Updated!</h1>
                    </div>
                    <div className="updatedbody">
                        You Profile has been successfully Updated
                    </div>
                    <div className="updatedfooter">
