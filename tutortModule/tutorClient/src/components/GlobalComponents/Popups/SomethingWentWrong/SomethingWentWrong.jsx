...
function SomethingWentWrong() {
    return (
        <div className="somethingWentWrongParent" style={{ position: "absolute", height: "100vh", width: "100%", backgroundColor: "rgba(0, 0, 0, 0.30)", zIndex: 1, justifyContent: "center", alignItems: "center", display: "flex" }}>
            <div className="somethingWentWrongBackground">
                <div className="somethingWentWrongContainer">
                    <div className="somethingWentWrongtitleCloseBtn">
                        <button>
                    ...
                    <div className="somethingWentWrongtitle">
                        <div className="somethingWentWrongicon">
                        ...
                        <h1 style={{ color: "rgba(101, 6, 6, 0.80)", textAlign: "center", fontSize: "23px", fontStyle: "normal", fontWeight: "600", marginTop: "-30px" }}>Oops! Something went Wrong.</h1>
                    </div>
                    <div className="somethingWentWrongbody">
                        Please check your provided Details Carefully.
                    </div>
                </div>
            </div>
        </div>
