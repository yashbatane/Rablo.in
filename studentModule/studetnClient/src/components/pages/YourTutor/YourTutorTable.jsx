...
import './YourTutorTable.css';
// import profilepic from "../../../../../../img/profilepic.webp";

import axios from 'axios'

const YourTutorTable = props => {
  ...
  const handleAcceptClick = () => {
    axios.post(`http://localhost:5003/api/accept/${row.id}` , {studentId :studentId })
    .fetch(function(resp){
      console.log(resp)
    })
  ...
  const handleDeclineClick = () => {
    axios.post(`http://localhost:5003/api/decline/${row.id}` , {studentId :studentId })
    .fetch(function(resp){
      console.log(resp)
    })
    .catch(function(error){
