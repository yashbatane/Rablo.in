    ...
    <div>
      <div className="privacy-policy-container">
        <div class="privacy-policy-text">
          ...
          <p>Effective date: 2020-07-09</p>
          <p>
            1. <b>Introduction</b>
          </p>
          <p>
            Welcome to <b> HOMETUITIONEDU (OPC) PRIVATE LIMITED</b>.
          </p>
          <p>
            <b>HOMETUITIONEDU (OPC) PRIVATE LIMITED</b> (“us”, “we”, or “our”)
            operates <b>https://hometuitioninc.in/</b> (hereinafter referred to
            as <b>“Service”</b>).
          </p>
          <p>
            Our Privacy Policy governs your visit to{" "}
            <b>https://hometuitioninc.in/</b>, and explains how we collect,
          ...
          <br />
          <p>
            <strong>Duties and Responsibilities of Tutor</strong>
          </p>
          <ol>
            <li>
              Maximum FOUR leaves are only allowed to the tutors which must be
              covered on Sundays. Extra leaves are subject to parents’
              allowance.
            </li>
            <li>
              Tutors will be provided with an attendance sheet which has to be
              submitted at the last of the tutor’s month with a monthly lesson
              planner which shall be provided to the parents as well.
            </li>
            <li>
              Trail class (THREE days) must be provided to all students which
              will be free of cost and parents are free to stop or continue the
              further paid service.
            </li>
            <li>
              Trail class commencement letter must be duly signed by the tutor
              as well as a parent before the trial class commencement.
            </li>
            <li>
              A monthly lesson planner should be built for the student within
              SIX days of every month and should be submitted to the institute
              asap.&nbsp;
            </li>
            <li>
              The tutor will receive the tuition fee on the last day of each
              month. FIFTY percentage of the fee will be deducted as a
              processing charge at the first-month fee credit.
            </li>
            <li>
              Tutors must deposit the address and id proof matching with the
            ...
            <li>
              Parents are eligible for charge-free cancellation of service
              within SEVEN days of service commencement, the fee shall be
              refunded back to parents and no tuition fee will be paid to tutor
              except commuting charge for sessions taking place.
            </li>
            <li>
              Any physical punishment to a student is strictly prohibited under
              our supervision.
            </li>
            <li>
              The tutor must sign the duties and responsibilities agreement
              before the registration completion.
            </li>
            <li>
              The tutor must submit their bank details within one month of class
              commencement.
            </li>
            <li>
              All the monthly or quarterly payments will be received by the
              institute to ensure fair practice and credited to the provided
              tutor’s bank after submission of the completed monthly lesson
              planner &amp; attendance sheet.
            </li>
            <li>
              Tutor’s registration is valid for one year only, renewal is
              required after expiry.
            </li>
            <li>
              Any content submitted by the tutor to the company or in the name
              of the company will be under the copyright of HOMETUITIONEDU OPC
              PVT LTD.
            </li>
            <li>
              If the tutor continues the services within a month of expiration
              of the demo period without the consent of the institute. It will
              be considered as a violation of terms and policies and he/she will
              be charged a penalty per violation.
              <br />
              Legal action can be taken as per damage/ loss by the violation.
            </li>
          </ol>
          <br />
          <p>
            <strong>Duties and Responsibilities of Parents</strong>
          </p>
          <ol>
            <li>
              A monthly or quarterly fee has to be submitted within SIX days of
              each month in advance or else services will be suspended.
            </li>
            <li>
              A fee has to be submitted to the institute only through the
              available mode of payment at the time else parents will only be
              liable for the loss of payment.
            </li>
            <li>
              Before discontinuing the services, SEVEN days prior notice must be
              provided else responsible will be liable for the penalty.
            </li>
            <li>
              If the tutor or parent breaks the service for more than two weeks
              without any pre-notice, the fund submitted will be redeemed or
              refunded as per the case.
            </li>
            <li>
              Annually increment of TEN percentage of the initial fee is obliged
              to the parents.
            </li>
            <li>
              After the expiration of the trial class, it is mandatory to inform
              us of the confirmation or cancellation of the tuition service.
            </li>
            <li>
              If service remains to continue after the expiry of the demo
              period, it will be considered as paid service and the parent or
              guardian shall pay the per day fee according to the no. of the
              paid service days.
            </li>
            <li>
              &nbsp;Parents will be asked for feedback from the respective tutor
              at the end of each month and are advised to provide fair feedback.
            </li>
            <li>
              Parents have to complete a verification request for the
              commencement of the trial class.
            </li>
            <li>
              Trail class commencement letter/form must be duly signed by the
              tutor as well as the parent before the trial class commencement.
            </li>
            <li>
              Parents must sign the duties and responsibilities agreement after
              the expiration of the trial class
            </li>
            <li>&nbsp;Legal action can be taken against any violations.</li>
          </ol>
          <p>
            2. <b>Definitions</b>
          </p>
          <p>
            <b>SERVICE</b> means the https://hometuitioninc.in/ website operated
            by HOMETUITIONEDU (OPC) PRIVATE LIMITED.
          </p>
          <p>
          ...
          <p>
            HOMETUITIONEDU (OPC) PRIVATE LIMITED uses the collected data for
            various purposes:
          </p>
          ...
          <p>
            HOMETUITIONEDU (OPC) PRIVATE LIMITED will take all the steps
          ...
          <p>
            ...
            us at <b>info@hometuitioninc.in</b>.
          </p>
          ...
          <p>
            ...
            please send your request(s) by email: <b>info@hometuitioninc.in</b>.
          </p>
          <p>
          ...
          <p>
            ...
            us by email: <b>admin@rablo.in</b>
          </p>
          <p>
            This{" "}
            <a
            ...
            was created for <b>https://hometuitioninc.in/</b> by{" "}
            <a
              href="https://policymaker.io"
              rel="nofollow noopener"
              target="_blank"
